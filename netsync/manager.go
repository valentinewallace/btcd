...
func (sm *SyncManager) startSync() {
	...
	for peer, state := range sm.peerStates {
		...
		// If the peer is at the same height as us, we'll add it to set
		// of backup peers to try in case we find one with a higher
		...
		// it own of our best peers from which we'll select randomly.
